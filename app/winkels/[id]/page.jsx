                ...
                <>
                    ...
                    <div className="bg-white shadow-lg rounded-lg mt-8 mx-10 w-full max-w-3xl px-6 py-8 sm:p-10">
                        <div className="text-center">
                            ...
                            <p className="text-md text-gray-600 mb-6">Ik ben een student die deze tool in zijn eentje in de lucht houdt. Je kunt al vanaf 1 euro doneren! Ik drink graag een biertje op jou!</p>
                            <a
                        ...
                        <div className="px-4 py-5 sm:p-6">
                            ...
                            <ul className="mt-5 space-y-4 max-h-48 overflow-y-auto">
                                {sortedReports.length > 0 ? (
                                    ...
                                    <p>Geen meldingen beschikbaar.</p>  // Fallback message if no reports
                                )}
                            </ul>
                        </div>
                    </div>
